...
<!DOCTYPE html>
	...
	font-size: 25px;
	color: white;
	background-color: #2251dd;">Register</div>
		<div class="addMemberForm">
			<form action="home.php" method="POST" enctype="multipart/form-data" class="addform">
				...
				<div class="inputs">
					<input type="text" name="lastName" required autofocus placeholder="Last-Name" pattern="[A-Za-z]{1,}" title="Last name must contain atleast 1 letters.">
				</div>
